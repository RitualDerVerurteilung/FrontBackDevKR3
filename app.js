...
async function subscribeToPush() {
    ...
    try {
        ...
        const subscription = await registration.pushManager.subscribe({
            ...
            applicationServerKey: urlBase64ToUint8Array('BGgjRMCYMYF5JOIzIOie24vlsPJoHQVKlIfngTMv_Qe0qXOgXCfiOF8Zzg16av8YZ2MU0UyWoCS9SfCFOUIotoM')
        });
            ...
            if (enableBtn && disableBtn) {
                ...
                enableBtn.addEventListener('click', async () => {
                    if (Notification.permission === 'denied') {
                        alert('Уведомления запрещены. Разрешите их внастройках браузера.');
                        return;
                    }
